...
FractalCreator::FractalCreator(int width, int height):
    m_width(width), 
    m_height(height),
    m_pHistogram(new int[Mandelbrot::MAX_ITERATIONS]{}), 
    m_pFractal(new int[m_height * m_width]{}),
...
void FractalCreator::addZoom(const Zoom& zomm){
    m_zoomList.add(zomm);
